...
namespace DemoGoiAPI // Nhớ giữ nguyên chữ này cho khớp với máy bạn nhé
{
    public partial class Form1 : Form
    {
        ...
        // ==========================================
        // 1. TẠO GIAO DIỆN MÀN HÌNH CHÍNH
        // ==========================================
        private void InitializeMainUI()
        {
            ...
            // Khung hiển thị kết quả (Đã fix lỗi tiếng Việt)
        ...
        // ==========================================
        // 2. TẠO CỬA SỔ POPUP ĐĂNG NHẬP
        // ==========================================
        private void ShowLoginDialog()
        {
            // Tạo một Form mới tinh làm cửa sổ con
            ...
            // Xử lý khi bấm nút Đăng nhập trên cửa sổ con
                ...
                using (HttpClient client = new HttpClient())
                {
                    try
                    {
                        ...
                        if (res.IsSuccessStatusCode)
                        {
                            ...
                            frmLogin.Close(); // Đăng nhập xong thì tự đóng cửa sổ
                        }
                    }
            ...
            frmLogin.ShowDialog(); // Lệnh này làm cửa sổ hiện lên ở dạng Popup
        }

        // ==========================================
        // 3. TẠO CỬA SỔ POPUP ĐĂNG KÝ
        // ==========================================
                ...
                using (HttpClient client = new HttpClient())
                {
                    try
                    {
                        ...
                        if (res.IsSuccessStatusCode)
                        {
                            ...
                            frmReg.Close(); // Đăng ký xong tự đóng cửa sổ
                        }
                    }
                    catch (Exception ex) { MessageBox.Show("Lỗi: " + ex.Message); }
        ...
        // ==========================================
        // 4. API GET: TẢI MENU VÀ HIỂN THỊ JSON
        // ==========================================
        ...
        // Hàm này đã bao gồm tính năng hiển thị tiếng Việt cực chuẩn
